...
fig=figure, topoplot(avg_n1_all_teams, chan_locs, 'electrodes', 'labels', 'maplimits', 'maxmin'), title('All teams', 'FontSize',15),
colorbar,clim([-3.5,3.5]),
c = colorbar
c.Label.String = 'uV'
c.FontSize = 15
...
fig=figure, topoplot(avg_n1_avg, chan_locs, 'electrodes', 'labels', 'maplimits', 'maxmin'), title('Average reference', 'FontSize',15),
colorbar,clim([-3.5,3.5]),
c = colorbar
c.Label.String = 'uV'
c.FontSize = 15
...
fig=figure, topoplot(avg_n1_mastoid, chan_locs, 'electrodes', 'labels', 'maplimits', 'maxmin'), title('Mastoid reference', 'FontSize',15)
colorbar,clim([-3.5,3.5]),
c = colorbar
c.Label.String = 'uV'
c.FontSize = 15
...
fig=figure, topoplot(avg_n1_orig, chan_locs, 'electrodes', 'labels', 'maplimits', 'maxmin'), title('Original reference', 'FontSize',15)
colorbar,clim([-3.5,3.5]),
c = colorbar
c.Label.String = 'uV'
c.FontSize = 15
